...
#' recognition) software FormScanner (\url{http://www.formscanner.org/}). This
#' package can convert the resulting FormScanner csv-file (in reality a
#' semicolon separated file) into a Microsoft Excel workbook (xlsx-file) with
#' the same content layout as generated by EDUsupport.
#'
...
#' \itemize{
#'  \item a file containing the answer key for the various versions (at most 4:
#'  A, B, C, D) used,
#'  \item a file containing the students that registered for the exam,
#'  \item a file containing the practicum information about the students,
